...
| steady_low | napi_polling | 826 | 825 | 0 | 1 | 203 | 0.246 | 17.0 | 0.900 |
...
| overload_spike | napi_polling | 42548 | 32704 | 9844 | 0 | 149 | 0.005 | 8.0 | -0.448 |
...
- NAPI-style polling reduces counted hardware interrupts during bursts while keeping service budget limits.
